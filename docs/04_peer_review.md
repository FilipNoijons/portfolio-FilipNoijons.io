...
```
## Installing package into 'C:/Users/filip/AppData/Local/R/win-library/4.5'
...
## 	C:\Users\filip\AppData\Local\Temp\Rtmp6LmGcA\downloaded_packages
```
...
|Transparency_Criteria       |Response_Type               |
|:---------------------------|:---------------------------|
|Study Purpose               |1                           |
|Data Availability Statement |0                           |
|Data Location               |0, data location in unknown |
|Study Location              |1, exact location is known  |
|Author Review               |1                           |
|Ethics Statement            |1                           |
|Funding Statement           |0                           |
|Code Availability           |0                           |
